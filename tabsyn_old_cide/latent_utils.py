...
def preprocess_new_dataset(csv_path, info):
    # Read the new dataset
    data = pd.read_csv(csv_path)

    # Assuming info contains necessary details about numerical and categorical columns
    num_col_idx = info['num_col_idx']
    cat_col_idx = info['cat_col_idx']

    x_num = data.iloc[:, num_col_idx].values
    x_cat = data.iloc[:, cat_col_idx].values
